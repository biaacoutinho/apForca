public class Palavra implements Comparable<Palavra>
{
    ...
    public Palavra (String texto) throws Exception
    {
        ...
        if (texto == null || texto == "")
            throw new Exception ("Não há caracteres");
    ...
    public int getPosicaoDaIezimaOcorrencia (int i, char letra) throws Exception
    {
        ...
        for (int c = 0; c < this.texto.length(); c += 1)
        {
        ...
        throw new Exception ("A letra não foi encontrada");
    }
    ...
    public int hashCode ()
    {
        ...
        ret = 2 * ret + String.valueOf(this.texto).hashCode();
